...
np.save("../../data/transaction_per_block.npy", t_block)
...
np.save("../../data/ringsize.npy", ring_size)
...
np.save("../../data/inter_time.npy", min_tx)

# save all table in a npz file
np.savez("../../data/blockchain_assumptions.npz", 
