...
transaction_per_block = pd.read_csv("../../data/statistics/transactions_per_block.csv")
...
# ringsize
ringsize = pd.read_csv("../../data/statistics/ringsize.csv")
...
min = pd.read_csv("../../data/statistics/min_between_transactions.csv")
